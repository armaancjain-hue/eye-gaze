...
export default function CalibrationOverlay({
  ...
  useEffect(() => {
    ...
    const settleTimer = setTimeout(() => {
      ...
      finishTimer = setTimeout(() => {
        ...
        const raw = points.length >= MIN_SAMPLES_PER_TARGET ? robustPoint(points) : null
        if (!raw) {
          setMessage('Tracking was unstable. Trying this target again.')
          setTimeout(() => {
  ...
  }, [displayTarget, index, onComplete, phase, rawGazePointRef, retryKey, storeTarget, targets.length])
